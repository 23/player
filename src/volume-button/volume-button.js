...
Player.provide("volume-button", {}, function (Player, $, opts) {
  var $this = this;
  $.extend($this, opts);
  ...
  var _buttonClass = "";
  Player.bind(
    "player:video:volumechange player:video:play player:video:pause player:video:loaded",
    function (e) {
  ...
  $this.setVolumeFromEvent = function (e) {
    ...
    var v =
      ($this.volumeSlider.height() - offsetY - 12) /
      ($this.volumeSlider.height() - 24);
    Player.set("volume", v);
  };
